...
* `Ludwig van Beethoven – Piano Sonatas <https://github.com/DCMLab/beethoven_piano_sonatas/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the first movement of the first sonata Op. 2 no. 1 has the following files:
...
-  ``harmonies/01-1.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/beethoven_piano_sonatas/issues>`__ and feel free to fork and submit pull requests.
